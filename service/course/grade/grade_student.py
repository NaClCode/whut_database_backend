...
grade_student_router = APIRouter()

@grade_student_router.get("/student")
async def _(body: CourseGradeSchema = Depends(), token_payload: dict = Depends(validate_student_token), db: Session = Depends(get_db)):
